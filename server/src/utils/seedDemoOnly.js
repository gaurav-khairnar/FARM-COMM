...
async function seedDemoOnly() {
  ...
  console.log('Demo seed complete (non-destructive).');
  ...
  console.log('farmer3@test.com / password123');
  console.log('buyer1@test.com / password123');

  await mongoose.disconnect();
}

seedDemoOnly().catch(async (error) => {
